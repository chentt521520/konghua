package com.shijiucheng.konghua.main.Json_.ordershaixuanview.utils1.utils;
...
public class MonthDateView extends View {
    ...
    //	private int mDayColor = Color.parseColor("#999999");
    private int mDayColor = Color.parseColor("#666666");
    private int mSelectDayColor = Color.parseColor("#ffffff");
    private int mSelectBGColor = Color.parseColor("#ec702d");
    private int mCurrentColor = Color.parseColor("#ec702d");
    ...
    protected void onDraw(Canvas canvas) {
        ...
        for (int day = 0; day < mMonthDays; day++) {
            ...
            if (dayString.equals(mSelDay + "")) {
                ...
                if (mSelYear < mCurrYear || ((mSelYear == mCurrYear) & ((mSelMonth) < mCurrMonth))) {
                    mPaint.setColor(Color.parseColor("#666666"));
                }
            }
...
//					}
    ...
    public interface DateTouch {
        void onTouchOnDate(String touch);
    }
