        ...
        public void onClick(View v) {
            switch (v.getId()) {
                ...
                case R.id.pop_picker_confirm:
                    String id;
                    if (index == 0) {
                        addressStrs.append(list.get(picker_province.getValue()).getCity()).append(" ");
                        id = list.get(picker_province.getValue()).getCityId();
                    } else if (index == 1) {
                        addressStrs.append(list.get(picker_city.getValue()).getCity()).append(" ");
                        id = list.get(picker_city.getValue()).getCityId();
                    } else {
                        addressStrs.append(list.get(picker_district.getValue()).getCity());
                        id = list.get(picker_district.getValue()).getCityId();
                    }
                    index++;
